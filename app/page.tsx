        ...
        <section className="relative min-h-[90vh] flex flex-col justify-center px-8 md:px-24 py-20 pt-32 md:py-32 md:pt-48">
          ...
          <div className="max-w-4xl relative z-10">
            ...
            <h1 className="font-headline text-4xl sm:text-5xl md:text-8xl text-white leading-[1.1] font-extralight tracking-tight">
              Estrategias legales profundas para decisiones <span className="italic font-normal">corporativas complejas</span>.
            </h1>
        ...
        <section className="py-20 md:py-32 px-8 bg-surface-bright flex justify-center text-center">
          <div className="max-w-4xl">
            ...
            <div className="text-on-surface-variant font-body text-lg leading-relaxed text-justify-custom space-y-6">
              ...
              <p>
                Hoy, el mercado exige transparencia y las firmas corporativas ya no pueden esconderse. La inauguración de nuestras nuevas oficinas marca el inicio de una nueva etapa: salimos a la luz para poner nuestra metodología, nuestra red de contactos y nuestro rigor técnico al servicio de un grupo selecto de empresas medianas e inversores que buscan un aliado estratégico a largo plazo.
              </p>
          ...
          <div className="max-w-screen-xl mx-auto bg-surface-container border border-secondary/20 text-white p-8 md:p-24 relative overflow-hidden rounded-2xl shadow-2xl">
            ...
            <div className="relative z-10 grid md:grid-cols-2 gap-16 items-center">
              ...
              <form className="space-y-8">
                ...
                <button aria-label="Solicitar Reunión" className="w-full bg-secondary text-primary py-6 text-xs font-bold tracking-[0.3em] hover:bg-white hover:text-primary transition-all duration-300 rounded-sm" type="submit">SOLICITAR REUNIÓN</button>
              </form>
            </div>
          </div>
        </section>

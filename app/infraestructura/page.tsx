      ...
      <main>
        ...
        <section className="relative min-h-[85vh] flex flex-col justify-center px-8 md:px-24 py-20 pt-32 md:py-32 md:pt-48">
          ...
          <div className="max-w-5xl relative z-10">
            ...
            <h1 className="font-headline text-4xl sm:text-5xl md:text-7xl text-white leading-[1.1] font-extralight tracking-tight mb-8">
              El fin del <span className="italic font-normal">"Costo Hundido"</span>: Monetice la infraestructura eléctrica de sus desarrollos.
            </h1>
          ...
          <div className="max-w-screen-xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-white font-body leading-relaxed text-lg font-semibold">
                En <span className="text-secondary">BPB Abogados</span> aportamos una visión integral de Real Estate. Entendemos su timing crítico.
              </p>
            </div>
            ...
            <div className="space-y-6">
              <div className="bg-surface-container-low p-8 border border-white/5 rounded-xl hover:border-secondary/30 transition-colors duration-500">
                ...
                <p className="text-on-surface-variant font-body leading-relaxed pl-10">
                  Iniciamos las acciones de recupero estratégicamente <strong className="text-white font-medium">una vez asegurado el suministro y formalizada la transferencia de la obra</strong>. Recuperamos su capital por vías paralelas seguras sin interferir en sus relaciones comerciales.
                </p>
              </div>
              <div className="bg-surface-container-low p-8 border border-white/5 rounded-xl hover:border-secondary/30 transition-colors duration-500">
                <div className="flex items-center gap-4 mb-4">
                ...
                <p className="text-on-surface-variant font-body leading-relaxed pl-10">
                  No es una aventura legal. Nos basamos en el Art. 19 de la Ley 24.065 (Abuso de Posición Dominante) y aprovechamos el actual escenario regulatorio, donde el ENRE ha aplicado altas multas recientes a las concesionarias por incumplimientos.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="max-w-screen-xl mx-auto flex flex-col lg:flex-row gap-16 items-start">
            ...
            <div className="lg:w-1/2 w-full">
              <div className="bg-primary p-8 md:p-12 border border-secondary/20 rounded-2xl shadow-2xl relative overflow-hidden">
                ...
                <h3 className="font-headline text-3xl text-white mb-6 italic relative z-10">¿Qué insumos necesitamos de su parte?</h3>
        ...
        <section id="calendly" className="py-20 md:py-32 px-8 bg-surface-bright border-t border-white/5">
          <div className="max-w-5xl mx-auto text-center">
            ...
            <h2 className="font-headline text-4xl md:text-5xl text-white font-light italic mb-12">

  ...
  return (
    <div>
      <main>
        ...
        <section className="relative min-h-[85vh] flex flex-col justify-center px-8 md:px-24 py-20 pt-32 md:py-32 md:pt-48">
          ...
          <div className="max-w-5xl relative z-10">
            ...
            <h1 className="font-headline text-4xl sm:text-5xl md:text-7xl text-white leading-[1.1] font-extralight tracking-tight mb-8">
              El fin del <span className="font-normal">"Costo Hundido"</span>: Monetice la infraestructura eléctrica de sus desarrollos.
            </h1>
        ...
        <section className="py-20 px-8 bg-surface border-b border-white/5">
          <div className="max-w-5xl mx-auto text-center">
            <p className="font-headline text-2xl md:text-3xl text-white/80 leading-relaxed font-light">
              <strong className="text-white font-normal">En BPB Abogados asesoramos y representamos</strong> a desarrolladores inmobiliarios, fiduciarios, constructoras y consorcios de copropietarios en reclamos vinculados a instalaciones eléctricas, cámaras transformadoras, centros de transformación y servidumbres administrativas de electroducto impuestas por distribuidoras de energía eléctrica como Edesur y Edenor.
            </p>
          </div>
        </section>
        ...
        <section className="py-20 md:py-32 px-8 bg-background">
          <div className="max-w-screen-xl mx-auto">
            <div className="text-center mb-16 md:mb-24 max-w-3xl mx-auto">
              <p className="font-label text-xs uppercase tracking-[0.3em] text-secondary font-semibold mb-4">Alcance de Intervención</p>
              <h2 className="font-headline text-3xl md:text-5xl text-white font-light leading-snug">
                Recupero integral de costos frente a imposiciones técnicas abusivas.
              </h2>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
              ...
              <div className="md:col-span-8 bg-surface-container p-10 md:p-14 rounded-2xl border border-white/5 relative overflow-hidden group hover:border-secondary/30 transition-colors duration-500">
                ...
                <div className="relative z-10">
                  <h3 className="font-headline text-2xl md:text-3xl text-white mb-6">Análisis y Representación Integral</h3>
                  <p className="font-body text-lg text-on-surface-variant leading-relaxed mb-6">
                    Nuestra intervención comprende el análisis integral de la legalidad y alcance de las exigencias técnicas y económicas impuestas durante el desarrollo de emprendimientos inmobiliarios.
                  </p>
                  <p className="font-body text-lg text-white/80 leading-relaxed">
                    Promovemos reclamos administrativos y judiciales destinados al recupero de los costos de construcción, adecuación, cesión de espacios, afectación de superficies y demás erogaciones asumidas para la instalación de cámaras transformadoras y tendidos eléctricos.
                  </p>
                </div>
              </div>
              ...
              <div className="md:col-span-4 bg-primary p-10 rounded-2xl border border-secondary/20 relative overflow-hidden flex flex-col justify-center">
                <div className="relative z-10">
                  ...
                  <h3 className="font-headline text-2xl text-white mb-4">Enfoque Estratégico</h3>
                  <p className="font-body text-on-primary-container leading-relaxed">
                    Brindamos un enfoque orientado tanto a la <strong className="text-white font-semibold">prevención de contingencias</strong> durante la etapa de desarrollo del proyecto como al <strong className="text-white font-semibold">recupero económico</strong> de los costos indebidamente trasladados.
                  </p>
                </div>
              </div>
              ...
              <div className="md:col-span-6 bg-surface-container-low p-10 rounded-2xl border border-white/5 hover:border-secondary/20 transition-colors">
                <h3 className="font-headline text-xl text-white mb-8">Ámbitos de Actuación</h3>
                <ul className="space-y-6">
                  <li className="flex items-start gap-4">
                    <ArrowRight className="text-secondary w-5 h-5 shrink-0 mt-1" />
                    <p className="font-body text-on-surface-variant leading-relaxed">Procedimientos ante el Ente Nacional Regulador de la Electricidad (ENRE).</p>
                  </li>
                  <li className="flex items-start gap-4">
                    <ArrowRight className="text-secondary w-5 h-5 shrink-0 mt-1" />
                    <p className="font-body text-on-surface-variant leading-relaxed">Negociaciones extrajudiciales y litigios vinculados a la constitución y compensación de servidumbres de electroducto.</p>
                  </li>
                  <li className="flex items-start gap-4">
                    <ArrowRight className="text-secondary w-5 h-5 shrink-0 mt-1" />
                    <p className="font-body text-on-surface-variant leading-relaxed">Indemnizaciones por afectación de partes comunes, depreciación funcional y ocupaciones permanentes.</p>
                  </li>
                </ul>
              </div>
              ...
              <div className="md:col-span-6 bg-surface-container-low p-10 rounded-2xl border border-white/5 hover:border-secondary/20 transition-colors">
                <h3 className="font-headline text-xl text-white mb-8">Sustento Normativo</h3>
                <div className="flex flex-wrap gap-3 mb-8">
                  <span className="px-4 py-2 bg-white/5 rounded-full text-xs font-label uppercase tracking-widest text-white/80 border border-white/10">Ley N° 24.065</span>
                  <span className="px-4 py-2 bg-white/5 rounded-full text-xs font-label uppercase tracking-widest text-white/80 border border-white/10">Ley N° 19.552</span>
                  <span className="px-4 py-2 bg-white/5 rounded-full text-xs font-label uppercase tracking-widest text-white/80 border border-white/10">Código Civil y Comercial</span>
                </div>
                <p className="font-body text-on-surface-variant leading-relaxed text-base">
                  La actuación se sustenta en la Ley Nacional de Energía Eléctrica, la Ley de Servidumbre Administrativa de Electroducto y el Código Civil y Comercial —particularmente en materia de responsabilidad, restricciones al dominio y reparación plena— junto con la normativa reglamentaria del ENRE.
                </p>
              </div>
          ...
          <div className="max-w-screen-xl mx-auto flex flex-col lg:flex-row gap-16 items-start">
            ...
            <div className="lg:w-1/2 w-full">
              <div className="bg-primary p-8 md:p-12 border border-secondary/20 rounded-2xl shadow-2xl relative overflow-hidden">
                ...
                <h3 className="font-headline text-3xl text-white mb-6 relative z-10">¿Qué insumos necesitamos de su parte?</h3>
            ...
            <div className="md:w-2/3 space-y-12">
              <div className="border-b border-white/10 pb-8">
                ...
                <p className="text-on-surface-variant font-body text-lg leading-relaxed">
                  Absolutamente no. La conexión eléctrica y el reclamo de capital corren por vías diferentes. Nuestras acciones se inician estratégicamente después de asegurar el suministro, garantizando que pueda entregar sus unidades a tiempo.
                </p>
              </div>
              <div className="border-b border-white/10 pb-8">
              ...
              <div>
                ...
                <p className="text-on-surface-variant font-body text-lg leading-relaxed">
                  Porque la afectación a perpetuidad de sus metros cuadrados constituye una "Servidumbre Administrativa de Electroducto". Esta limitación al uso y valor de su propiedad común debe ser indemnizada económicamente.
                </p>
              </div>
            </div>
          </div>
        ...
        {/* Calendly Section */}
        <section id="calendly" className="py-20 md:py-32 px-8 bg-surface-bright border-t border-white/5">
          <div className="max-w-5xl mx-auto text-center">
            <p className="font-label text-xs uppercase tracking-[0.3em] text-secondary font-semibold mb-6">Agendar Sesión</p>

...
1.  **Imponer Cromática de Prestigio Legal**: Construye la base del color en la interfaz empleando exclusivamente tonos que emanen autoridad clásica. Usa obligatoriamente como cimiento una tonalidad de "Azul Navy" robusta (`#1a2b3c`), e implementa brillos cromáticos secundarios usando solo variaciones sutiles de "Dorado Suave" (para acentos de estatus) o "Gris Piedra" (para superficies secundarias o texto).

...
export function Footer() {
  return (
    <footer className="bg-primary w-full py-12 md:py-20 px-6 md:px-8">
          ...
          <div className="flex gap-4 md:gap-6">
            <a href="https://www.instagram.com/bpb.abogados?igsh=MXZhdmN4YmJxZnZ0" target="_blank" rel="noopener noreferrer" aria-label="Instagram de BPB Abogados" className="flex items-center gap-2.5 md:gap-3 group">
              <svg
                ...
                className="text-white/70 group-hover:text-secondary cursor-pointer transition-colors w-5 h-5 md:w-6 md:h-6"
              >
      ...
      <div className="max-w-7xl mx-auto mt-12 md:mt-20 text-center border-t border-white/10 pt-6 md:pt-8">
        <p className="font-body text-[10px] md:text-xs uppercase tracking-wider md:tracking-widest text-white/60">

...
export function Hero() {
  return (
    <section className="relative min-h-[70vh] md:min-h-[90vh] flex flex-col justify-center px-8 md:px-24 py-20 pt-32 md:py-32 md:pt-48">
      ...
      <div className="max-w-4xl relative z-10 flex flex-col items-center md:items-start text-center md:text-left mx-auto md:mx-0">
        ...
        <h1 className="font-headline text-4xl sm:text-5xl md:text-7xl text-white font-light mb-8 leading-snug">
          Una sólida trayectoria orientada al asesoramiento integral.
        </h1>
        <p className="font-body text-base md:text-xl text-white/90 max-w-3xl leading-relaxed mb-10">
        ...
        <div className="mt-8 flex flex-col md:flex-row md:items-center gap-8 w-full md:w-auto">

        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div className="group cursor-pointer">
            <div className="relative aspect-[3/4] overflow-hidden bg-slate-100 mb-8 border-b-2 border-transparent group-hover:border-secondary transition-colors duration-500">
              <img alt="Retrato Profesional Dr. Guillermo Betard" className="w-full h-full object-cover object-top grayscale transition-all duration-700 group-hover:scale-105 group-hover:grayscale-0" src="https://res.cloudinary.com/dxbtafe9u/image/upload/v1779939996/WhatsApp_Image_2026-05-27_at_4.11.20_PM_yrjsl9.jpg" />
          ...
          <div className="group cursor-pointer">
            <div className="relative aspect-[3/4] overflow-hidden bg-slate-100 mb-8 border-b-2 border-transparent group-hover:border-secondary transition-colors duration-500">
              <img alt="Retrato Profesional Dr. Mariano Pacifico" className="w-full h-full object-cover object-top grayscale transition-all duration-700 group-hover:scale-105 group-hover:grayscale-0" src="https://res.cloudinary.com/dxbtafe9u/image/upload/v1779940183/Gemini_Generated_Image_u8zqdyu8zqdyu8zq_q9pej9.jpg" />
              <div className="absolute inset-0 bg-gray-500/40 mix-blend-multiply pointer-events-none transition-opacity duration-700 group-hover:opacity-0"></div>
            </div>
          ...
          <div className="group cursor-pointer">
            <div className="relative aspect-[3/4] overflow-hidden bg-slate-100 mb-8 border-b-2 border-transparent group-hover:border-secondary transition-colors duration-500">
              <img alt="Retrato Profesional Dr. Rodrigo Biondi" className="w-full h-full object-cover object-top grayscale transition-all duration-700 group-hover:scale-105 group-hover:grayscale-0" src="https://res.cloudinary.com/dxbtafe9u/image/upload/v1779560047/rodrigo_cbqo2r.jpg" />
              <div className="absolute inset-0 bg-gray-500/40 mix-blend-multiply pointer-events-none transition-opacity duration-700 group-hover:opacity-0"></div>
            </div>
